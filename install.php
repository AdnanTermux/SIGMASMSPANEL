...
define('OTP_FETCH_INTERVAL', 60); // seconds
...
<div class="install-card">
  ...
  <div class="d-flex gap-2 mb-4 flex-wrap">
    ...
    <span class="env-badge <?= extension_loaded('pdo_mysql') ? '' : 'bg-red-50 border-red-200 text-red-700' ?>">
      <?= extension_loaded('pdo_mysql') ? '✓' : '✗' ?> PDO MySQL
    </span>
    <span class="env-badge <?= extension_loaded('curl') ? '' : 'bg-red-50' ?>">
      <?= extension_loaded('curl') ? '✓' : '✗' ?> cURL
    </span>
    <span class="env-badge <?= extension_loaded('json') ? '' : 'bg-red-50' ?>">
